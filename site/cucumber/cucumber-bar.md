...
order = [why, quick start, how to use, how it works, supported types, performance, worst possible object, videos, learn]

# 1.1

text = "suitkaise.cucumber"

# 1.2

button = "why"
link = "cucumber-why.md"
