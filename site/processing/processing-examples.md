...
text = "
(start of dropdown "Basic `Skprocess`")
## Basic `Skprocess`
...
(end of dropdown "Basic `Skprocess`")

(start of dropdown "`Pool`")
## `Pool`
...
(end of dropdown "`Pool`")

(start of dropdown "`Share`")
## `Share`
...
(end of dropdown "`Share`")

(start of dropdown "`Pipe`")
## `Pipe`
...
(end of dropdown "`Pipe`")

(start of dropdown "`Skprocess.tell()` and `Skprocess.listen()`")
...
(end of dropdown "`Skprocess.tell()` and `Skprocess.listen()`")

(start of dropdown "`autoreconnect`")
## `autoreconnect`
