...
how to use the sktime module. this is the default page when entered from the home page "learn more" or nav bar sidebar "sktime" link.
...
title = "How to use the `sktime` module"
