...
# suitkaise/int/eventsys/keyreg/compress_keys.py
...
from suitkaise_app.int.eventsys.data.enums.enums import CompressionLevel
import suitkaise_app.int.eventsys.keyreg.keyreg as keyreg
import suitkaise_app.int.utils.math.byte_conversions as byteconv
