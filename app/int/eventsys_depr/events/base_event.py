...
from suitkaise_app.int.eventsys.data.enums.enums import EventState, EventPriority

from suitkaise_app.int.eventsys.context.thread_context import (
...
import suitkaise_app.int.utils.formatting.format_data as fmt
...
class Event:
    ...
    * auto post on __exit__
    ...
    def _post(self):
        ...
        from suitkaise_app.int.eventsys.core_depr.bus.event_bus import EventBus
