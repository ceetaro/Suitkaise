...
from suitkaise_app.int.eventsys.data.enums.enums import EventState, ValueType, StationLevel
...
class EventBus:
    ...
    def _event_to_station(self, event, station_level: StationLevel = None):
        ...
        """
        from suitkaise_app.int.eventsys.core_depr.station import BusStation
