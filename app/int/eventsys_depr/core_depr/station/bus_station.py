...
from suitkaise_app.int.eventsys.core_depr.station.station import Station
    ...
    def _connect_to_main_station(self):
        ...
        with self._main_station_lock:
            if self.domain == SKDomain.INTERNAL:
                ...
                from suitkaise_app.int.eventsys.core_depr.station.int_station import IntStation
                ...
                from suitkaise_app.int.eventsys.core_depr.station.ext_station import ExtStation
