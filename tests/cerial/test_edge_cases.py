...
from suitkaise.cerial import serialize, deserialize, SerializationError, DeserializationError
...
def run_all_tests():
    ...
    runner = TestRunner("Cerial Edge Cases Tests")
