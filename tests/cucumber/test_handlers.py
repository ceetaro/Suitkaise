...
def test_serializer_class_with_methods():
...
def run_all_tests():
    ...
    runner = TestRunner("Cucumber API Tests")
    ...
    # Custom object tests
    runner.run_test("custom class roundtrip", test_serializer_custom_class)
    runner.run_test("class with methods roundtrip", test_serializer_class_with_methods)
