...
*10. build 0.4.7b0 package and upload to pypi
...
- site docs flow:
  ...
  1. source of truth is suitkaise-docs, DO NOT CHANGE ANYTHING WHEN COPYING TO SITE FILES
  2. site .md pseudo code files match the suitkaise-docs files, with annotations for things like dropdowns
  3. site html files follow the same style as they do now, but content is updated based on new site .md content
  4. for now, all modules have empty pages on videos, tests, and learn
    - order: why, quick start, how to use, how it works, examples, any other module-specific pages, videos, tests, learn

13. reconfigure site to support new version
- add changelog content to site under main nav bar, along with quick start guide
- revamp home page


14. create donation page and feedback form
- thru kofi or buymeacoffee
