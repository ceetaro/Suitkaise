...
The `WorstPossibleObject` is the **ultimate stress test** for cerial’s serialization engine.  
If cerial can round‑trip this object with 100% verification passing, it can handle real‑world data.
...
If cerial handles this, it handles anything.
