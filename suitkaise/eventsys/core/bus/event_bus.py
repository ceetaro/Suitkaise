...
# suitkaise/eventsys/core/bus/event_bus.py
...
from suitkaise.eventsys.data.enums.enums import EventState, ValueType, StationLevel
from suitkaise.eventsys.events.base_event import Event

from suitkaise.eventsys.context.thread_context import (
...
class EventBus:
    ...
    def _event_to_station(self, event, station_level: StationLevel = None):
        ...
        """
        from suitkaise.eventsys.core.station import BusStation
