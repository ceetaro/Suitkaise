"""
Test cucumber serialization (converting objects to bytes).
...
from suitkaise.cucumber._int.serializer import Serializer, SerializationError
...
class TestWorstPossibleObject:
    ...
    def test_worst_possible_object(self):
        ...
        every type that cucumber supports.
        """
        # Import the worst possible object
        sys.path.insert(0, str(Path(__file__).parent.parent.parent / "suitkaise" / "cucumber" / "_int" / "worst_possible_object"))
...
class TestErrorHandling:
    ...
    def test_debug_mode(self):
        ...
        serializer = Serializer(debug=False)
