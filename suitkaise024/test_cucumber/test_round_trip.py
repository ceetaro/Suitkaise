"""
Round-trip tests for cucumber serializer and deserializer.
...
class TestBasicRoundTrip:
    ...
    def setup_method(self):
        ...
        self.serializer = Serializer(debug=False, verbose=False)
        self.deserializer = Deserializer(debug=False, verbose=False)
