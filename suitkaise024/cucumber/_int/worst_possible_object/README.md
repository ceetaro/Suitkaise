...
This directory contains the comprehensive testing infrastructure for cucumber.
...
- **`test_worst_obj.py`** - Tests object creation (without cucumber)
...
The ultimate stress test for cucumber containing:
